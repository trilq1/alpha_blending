...
%     - ORBPoints object         - Oriented FAST and Rotated Brief (ORB)
...
%                    'BRISK', 'FREAK', 'SURF', 'ORB', 'KAZE', 'Block' or 'Auto'.
%
...
%
%   - When SURF, KAZE, ORB, FREAK or BRISK is used to extract descriptors, the
...
%   MSERRegions, cornerPoints, BRISKPoints object, ORBPoints object or KAZEPoints object, or
...
%     detectKAZEFeatures, detectORBFeatures, matchFeatures
...
%  ORB: an efficient alternative to SIFT or SURF, Willow Garage, Menlo Park,
%  California. IEEE International Conference on Computer Vision,2011.
%
...
str = validatestring(method,{'Block','SURF','KAZE','FREAK','BRISK','ORB','Auto'},...
    mfilename,'Method');
